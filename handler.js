                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (m.chat in global.db.data.chats || m.sender in global.db.data.users) {
                        ...
                        if (plugin.tags && plugin.tags.includes('game')) {
                            if (m.chat !== global.community.game) throw `Group ini tidak support untuk bermain game, silahkan gabung ke group khusus game >>${await conn.groupInviteCode(global.community.game)}`
                        }
