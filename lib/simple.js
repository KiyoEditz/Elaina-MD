...
END:VCARD`.trim()
    ...
    */
    ...
    conn.send2ButtonDoc = async (jid, content, footerText, button1, id1, button2, id2, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { forwardingScore: 99999, isForwarded: true }, ...options, ephemeralExpiration: global.ephemeral })
    }
    conn.send2ButtonImgDoc = async (jid, buffer, contentText, footerText, button1, id1, button2, id2, quoted, options) => {
        ...
        return await conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, ...options })
    }
    ...
    */
    ...
    conn.sendTemplateButtonLoc = async (jid, buffer, contentText, footer, buttons1, row1, quoted, options) => {
        ...
        }), { userJid: conn.user.jid, quoted: quoted, ephemeralExpiration: global.ephemeral, ...options });
    ...
    conn.sendTemplate = async (jid, content, footerText,amount, list = [], quoted, options) => {
        ...
        conn.sendMessage(jid, key, { quoted, ...options })
    }
