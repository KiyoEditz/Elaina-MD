...
END:VCARD`.trim()
    ...
    */
    ...
    conn.send2Button = async (jid, content, footerText, button1, id1, button2, id2, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { forwardingScore: 999999, isForwarded: true }, ...options })
    }
    ...
    */
    ...
    conn.sendTemplate = async (jid, buffer, content, footerText, button1, id1, quoted, options) => {
        const buttons = [
            { index: 1, urlButton: { displayText: dtu, url: urlnya } },
